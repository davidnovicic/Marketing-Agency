...
function ClientList() {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center -mt-38 items-end space-x-10 overflow-x-hidden sm:p-5 sm:space-x-0">
        ...
        <div className="grid grid-cols-3 gap-10 sm:grid-cols-1 sm:gap-3">
          {[
            ...
            <div className="bg-white shadow p-5 w-[400px] sm:w-auto sm:h-auto border h-[400px] z-0 ">
        ...
        {selectedClientIndex < 4 && (
          <i
            class="ri-arrow-right-line text-4xl text-gray-600 cursor-pointer sm:hidden"
            onClick={next}
          ></i>
        )}
      </div>
